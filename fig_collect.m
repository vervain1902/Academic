...
% License: https://github.com/jmgirard/DARMA/blob/master/LICENSE.txt
    ...
    % Set minimum size
    set(handles.figure_collect,'Units','normalized','Position',[0,0,1,1],'Visible','on');
    drawnow;
    ...
    handles.axis_circle = axes(handles.figure_collect, ...
        ...
        'XLim',[-1,1],'YLim',[-1,1], ...
        'NextPlot','add', ...
        'Box','on','XTick',(-1:0.25:1),'YTick',(-1:0.25:1), ...
        'XTickLabel',(-2:0.5:2),'YTickLabel',(-2:0.5:2),'Layer','top', ...
        'XGrid', 'on', 'YGrid', 'on', 'GridColor', 'black', 'GridAlpha', 0.3, ... 
